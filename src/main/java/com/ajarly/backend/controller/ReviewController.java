...
public ResponseEntity<Map<String, Object>> getPropertyReviews(
    ...
    try {
        ...
        Page<ReviewDto.Response> reviews = reviewService.getReviewsByProperty(propertyId, pageable);
        ...
        return buildErrorResponse("Failed to retrieve reviews", HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
